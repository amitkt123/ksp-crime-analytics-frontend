...
import {
  ...
  getCasteDemo,
  getOccupationDemo,
  getAccusedReligionDemo,
  getAccusedCasteDemo,
  getAccusedOccupationDemo,
...
export function DemographicsTab() {
  ...
  const accusedReligion = getAccusedReligionDemo();
  const accusedCaste = getAccusedCasteDemo();
  const accusedOccupation = getAccusedOccupationDemo();
